import { startConnection,startWorkitem } from "./apsda.js";
...
export function initTree(selector, onSelectionChanged) {
    ...
    tree.on('node.click', function (event, node) {
        ...
        if (tokens[0] === 'item') {
            ...
            const itemUrl = `https://developer.api.autodesk.com/data/v1/projects/${tokens[2]}/items/${tokens[3]}`;       
            startWorkitem(itemUrl);
        };
    });
